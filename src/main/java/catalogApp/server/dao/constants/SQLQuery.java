...
public class SQLQuery {
    ...
    public static String ALL_BOOKS() {
        return  "select O.idObject as idObject, O.name as objectName, O.isArchived as archived, O.img as image," +
                " O.comment as comment, AV2.idObject as authorId, AV2.name as authorName" +
    ...
    public static String BOOK_BY_ID(int id) {
        return  "select O.idObject as idObject, O.name as objectName, O.isArchived as archived, O.img as image, O.comment as comment, AV2.idObject as authorId," +
                " AV2.name as authorName" +
                " from Object O " +
    ...
    public static String ALL_SONGS() {
        return  "select O.idObject as idObject, O.name as name, O.isArchived as archived, O.img as image, O.comment as comment, AV.value as duration, AV3.idObject as idGenre," +
    ...
    public static String SONGS_BY_IDS(String paramName) {
        return "select O.idObject as idObject, O.name as name, O.isArchived as archived, O.img as image, O.comment as comment, AV.value as duration," +
